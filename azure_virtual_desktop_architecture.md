...
The task-level ranges below roll up to the phase ranges above; they are hands-on effort estimates, not calendar duration. They assume six initial users, up to 10 access terminals, a simple pooled host pool, one region, supported applications, and no major application redevelopment or regional disaster-recovery design.
