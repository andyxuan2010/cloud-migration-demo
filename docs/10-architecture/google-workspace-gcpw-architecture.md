...
**Document relationship:** This is the detailed design for Solution 2. The authoritative baseline remains [`requirements.md`](../90-decisions/requirements.md). Remote work and user/device portability are optional; endpoint security, recovery, data ownership, and AD dependency removal remain mandatory.
