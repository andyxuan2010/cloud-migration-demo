...
See the separate [Solution 1 detailed implementation action plan](solution_1_implementation_action_plan.md) for the task-level checklist, owners, dependencies, evidence, effort estimates, go/no-go gates, rollback controls, and handover requirements.
