...
The task-level ranges below roll up to the phase ranges above; they are hands-on effort estimates, not calendar duration. They assume a clean six-user implementation with simple Windows profiles, supported applications, and no major AD-hosted dependency remediation.
