...
| [google_workspace_gcpw_architecture.md](google_workspace_gcpw_architecture.md) | Detailed design for Option 2: Google Workspace + GCPW. |
| [azure_virtual_desktop_architecture.md](azure_virtual_desktop_architecture.md) | Detailed design for Option 3: Azure Virtual Desktop. |
...
2. **Option 2 — Google Workspace + GCPW**: a viable Google-first alternative when Windows management requirements are simple and feature gaps are validated.
3. **Option 3 — Azure Virtual Desktop**: a conditional option for centralized desktops, legacy applications, or controlled access-terminal scenarios; it adds Azure consumption and operational complexity.
...
| Option 2: Google Workspace + GCPW | CAD 3,500–6,600 | CAD 290–540 | CAD 375–900 |
| Option 3: Azure Virtual Desktop | CAD 7,250–15,600 | CAD 980–1,850 | CAD 750–1,800 |
...
- [Option 2 diagram](images/google_gcpw_target_architecture.png)
- [Option 3 diagram](images/azure_virtual_desktop_target_architecture.png)
